...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><img src="images/logo.png" style="height:100px; width:300px" />
       <br/><b style="color: #1B815F;">RASE<span style="color: #616065;"> Automation</span></b></a>
    </div>
    <div class="card-body">
      ...
      <form action="Signup.php" method="post">
        ...
        <div class="row">
          <div class="col-8">
            <a href="index.php" class="login-box-msg" style="color: #616065;">Already Registered, <br/>&nbsp;&nbsp;&nbsp;&nbsp; <i><b>Login here</b></i></a>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button name="sub" type="submit" class="btn btn-primary btn-block" style="background-color: #1B815F;">Sign Up</button>
          </div>
          <!-- /.col -->
        </div>
